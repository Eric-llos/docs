...
Las imágenes en colecciones de contenido se procesarán de la misma manera que lo hacen en [Markdown](#images-in-markdown-files) y [MDX](#images-in-mdx-files) dependiendo del tipo de archivo que estés utilizando.
